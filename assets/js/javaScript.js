...
const disciplinesList = {
    disciplines: [
        { discipline: "Animalism" }, { discipline: "Auspex" }, { discipline: "Blood Sorcery" }, { discipline: "Celerity" }, { discipline: "Dominate" },
        { discipline: "Fortitude" }, { discipline: "Obfuscate" }, { discipline: "Oblivion" }, { discipline: "Potence" }, { discipline: "Presence" },
        { discipline: "Protean" }, { discipline: "Thin-Blood Alchemy" }
    ]
};
const predatorTypes = {};
